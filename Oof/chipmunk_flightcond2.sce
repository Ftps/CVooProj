...
deg=%pi/180; g=9.81
h=1500; M=0.16; aa0=3.69*deg; gg0=0; u0=101.5*(463/900); flaps=0; tt0=aa0+gg0; //aa0 convertido para rad; u0 convertido para m/s
//throttle : 
...
a=[ybb,                    yp+sin(aa0),                  yr-1,                 g*cos(tt0)/u0,     0;
lbb+((Ixz/Ix)*nbb)      lp+((Ixz/Ix)*np),             lr+((Ixz/Ix)*nr)         0,                 0;
nbb+((Ixz/Ix)*lbb),     np+((Ixz/Ix)*lp),             nr+((Ixz/Ix)*lr),        0,                 0;
0,                      1,                            tan(tt0),                0,                 0;
0,                      0,                            1/cos(tt0),              0,                 0];
