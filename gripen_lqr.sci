...
max_x = [5*%pi/180, 20*%pi/180, 10*%pi/180, 20*%pi/180, 15*%pi/180];     // Valores máximos para os estados x e entradas u (Bryson)
max_u = [18*%pi/180, 23*%pi/180]; //temos depois de limitar isto à saida do sistema com um threshold
